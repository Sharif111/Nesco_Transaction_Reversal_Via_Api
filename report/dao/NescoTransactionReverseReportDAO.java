...
public class NescoTransactionReverseReportDAO {
	...
	public NescoTransactionReverseReportBO getPermissionCheckPro(	String sUserID,
			String sSessionID,
			String sCompanyID,
			String sBranchID,
			String sIPAddress,
		...
		NescoTransactionReverseReportBO oStatusReportofNPSBOutgoingBO = new NescoTransactionReverseReportBO();
	...
	public NescoTransactionReverseReportBO getMenuCheckPro( String sUserID,
			String sSessionID,
			String sCompanyID,
			String sBranchID,
	...
	public NescoTransactionReverseReportBO getMenuList( String sUserID,
	...
	public NescoTransactionReverseReportBO getStatusListData( String sUserID,String sSessionID)		throws Exception {
	...
	public NescoTransactionReverseReportBO getNescoDataPro( 
			String sUserID,
			String sSessionID,
			String sToDate,
			String RR
		...
		Connection oConn = null;
		oConn = DBCPNewConnection.getConnection();
		NescoTransactionReverseReportBO oPassportTransactionListBO = new NescoTransactionReverseReportBO();
		CallableStatement oStmt = oConn.prepareCall("{call IBMM.dpr_mm_nesco_bill_inf (?,?,?,?,?,?)}");
		oStmt.setString(1, sUserID);
		oStmt.setString(2, sSessionID);
		oStmt.setString(3, sToDate);
		oStmt.setString(4, RR);
	...
	public NescoTransactionReverseReportBO getExecutePro( 
			String sUserID,
			String sSessionID,
			String sToDate,
			String sStatus
...
//			System.out.println("DayendRefId2===>" + oPassportTransactionListBO.getsDayendRefId2());		
	...
	public NescoTransactionReverseReportBO NescoDataUpdatePro( 
			String sUserID,
			String sSessionID,
			String sToDate,
			String sStatus,
	 ...
	 public NescoTransactionReverseReportBO getNescoData(String sUserID, String sSessionID)
			    throws Exception
			  {
		 NescoTransactionReverseReportBO oNescoTransactionReverseReportBO = new NescoTransactionReverseReportBO();
			    ...
			    try
			    {
			     ...
			     // System.out.println("sql.toString()==> "+ sql.toString());
			      while (oRs.next()) {
			    	  NescoTransactionReverseReportBO oUserIDGenerationListBO = new NescoTransactionReverseReportBO();
			      ...
			      oNescoTransactionReverseReportBO.setUserIDGeneratedList(aCustomerIDList);
			    //System.out.println("oNescoTransactionReverseReportBO.setUserIDGeneratedList==>"+oNescoTransactionReverseReportBO.getUserIDGeneratedList());
			    }
			    catch (Exception sq)
			    {
			      sq.printStackTrace();
			    ...
			    return oNescoTransactionReverseReportBO;
			  }

	 
	 public NescoTransactionReverseReportBO getNescoTotalData(String sUserID, String sSessionID)
			    throws Exception
			  {
		// NescoTransactionReverseReportBO oNescoTransactionReverseReportBO = new NescoTransactionReverseReportBO();
			    Connection oConn = null;
	...
	public NescoTransactionReverseReportBO getStatusType() throws Exception{

		NescoTransactionReverseReportBO oFundTransfertoBkashWalletReportListBO = new NescoTransactionReverseReportBO();
		Connection oConn = null;
		Statement oStmt = null;
		oConn = DBCPNewConnection.getConnection();
		oStmt = oConn.createStatement();						
    ...
    public NescoTransactionReverseReportBO AgentDayEndRequest(NescoTransactionReverseReportBO model) {
        
        
    	NescoTransactionReverseReportBO outModel = new NescoTransactionReverseReportBO();
    ...
    public NescoTransactionReverseReportBO doCBSApi(
    		NescoTransactionReverseReportBO model) {
    ...
    public NescoTransactionReverseReportBO getAuthCode(NescoTransactionReverseReportBO model) {
    	NescoTransactionReverseReportBO outModel = new NescoTransactionReverseReportBO();
        Connection oConn = null;
        ...
        try {
           ...
           // Logger.getLogger(NescoTransactionReverseReportDAO.class.getName()).log(Level.SEVERE, null, ex);
            outModel.setErrorCode("1");
    ...
    /**First*/
    public NescoTransactionReverseReportBO getReverseData(NescoTransactionReverseReportBO model) {
    	NescoTransactionReverseReportBO outModel = new NescoTransactionReverseReportBO();
        Connection oConn = null;
        CallableStatement oStmt = null;
        ...
        try {
            ...
            if ("0".equals(outModel.getErrorCode())) {
            	...
            	model.setsReferenceId(oStmt.getString(4));
                 ...
                 System.out.println("**********");
                 System.out.println("reverse request---" + outModel.getAgentReveseRequestNo());
                 System.out.println("reverse ref-->"+outModel.getsReferenceId());
                 
           

                 NescoTransactionReverseReportDAO dao = new NescoTransactionReverseReportDAO();
                 NescoTransactionReverseReportBO reverse =   dao.reverseExecute(model);
    ...
    public NescoTransactionReverseReportBO reverseExecute(NescoTransactionReverseReportBO model) {

    	
    	
    	NescoTransactionReverseReportBO authCode = getAuthCode(model);
        ...
        sb.append("<TOKEN_NO />");
        sb.append("<REQ_NO>" + model.getsReferenceId() + "</REQ_NO>");
       ...
       // HttpPost httppost = new HttpPost(url);
        ...
        try {
            ...
            //   String decrypt = decrypt(response);
            // System.out.println("decrypt ---> = " + decrypt);
            //  model.setAgentResponse(responseinfo);
            //errorLog(model);
            if (response != "") {
    ...
    private String decrypt(String data, NescoTransactionReverseReportBO model) throws Exception {
   ...
   /** update transacton*/
    public NescoTransactionReverseReportBO reverseUpdate(NescoTransactionReverseReportBO model) {
    	NescoTransactionReverseReportBO outModel = new NescoTransactionReverseReportBO();
        Connection oConn = null;
        CallableStatement oStmt = null;
