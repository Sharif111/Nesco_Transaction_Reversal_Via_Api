package com.adminpanel.merchantadminpanel.nesco.bo;

import java.io.Serializable;
import java.util.ArrayList;

public class NescoTransactionReverseBO implements Serializable {
    ...
    private String agentReveseReferenceId = "";
	...
	public String getAgentReveseReferenceId() {
		return agentReveseReferenceId;
	}

	public void setAgentReveseReferenceId(String agentReveseReferenceId) {
		this.agentReveseReferenceId = agentReveseReferenceId;
	}
