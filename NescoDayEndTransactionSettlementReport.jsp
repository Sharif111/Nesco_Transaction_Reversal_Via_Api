...
<%@ page import="com.adminpanel.merchantadminpanel.nesco.report.bo.NescoDayEndTransactionSettlementReportBO"%>
...
<script language="javascript" type="text/javascript">
	...
	function doMainMenu(f){
		f.action="/merchantadminpanel/cancelNescoDayEndTransactionSettlementReport.do";
		f.submit();
	}	
	function doLogOut(f){		
	    var f = document.nescoDayEndTransactionSettlementReportForm;
		f.action="/merchantadminpanel/logOutIBanking.do";
		f.submit();
	}
	function doMenuList(f){
		f.action=document.nescoDayEndTransactionSettlementReportForm.menu.value;
		f.submit();
	}	
	
	function doSearch(){		
		var f = document.nescoDayEndTransactionSettlementReportForm;			
	 	f.action="/merchantadminpanel/showDataNescoDayEndTransactionSettlementReport.do";
	 	f.submit();			
	}
    ...
    function doClear(f){	 
	 	f.action="/merchantadminpanel/nescoDayEndTransactionSettlementReport.do";
		f.submit();	 
	 } 
...
<body onLoad="setBodyProperty()">
  <html:form action="/nescoDayEndTransactionSettlementReport" enctype="multipart/form-data" style="margin: 0">
                    ...
                    <td width="92%" class="myBankHeader"><table width="100%" border="0" cellspacing="3" cellpadding="0">
                        ...
                        <tr>
                          <td height="21" align="left" valign="top">&nbsp;</td>
                            ...
                            </font><font class="usr-4">Nesco Day End Transaction Settlement Report</font></td>
                          <td colspan="2" align="right" valign="top"><a href="#" onClick="doMainMenu(nescoDayEndTransactionSettlementReportForm)"><font class="usr-5">
        ...
        <td valign="top">
            ...
            <tr class="spaceUnder">
              ...
              <td align="right mt-2"><input type="button" value="Search" style="color:#03F;width:105px" data-toggle="modal" data-target="#confirm-submit" id="exeButton" />
                <input type="button" value="Clear" style="color:#03F;width:105px;margin-right:50px" name="sendMail" onClick="doClear(nescoDayEndTransactionSettlementReportForm)" /></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
    ...
    <div class="modal fade" id="confirm-submit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm">
         ...
         <div class="modal-footer">
              ...
              <a href="#" onClick="doSearch(nescoDayEndTransactionSettlementReportForm)" class="btn btn-success success">Search</a>
          </div>
      </div>
    </div>
  </div>
    ...
    <td colspan="9">
        ...
        <tr bgcolor="#99CCCC">
          <th valign="middle" width="4%" style="height: 35" class="lbl-b-08" align="center">Sl</th> 
            ...
            <th valign="middle" width="5%" class="lbl-b-08" align="left">Dayend Agent Ref No</th>
            <th valign="middle" width="5%" class="lbl-b-08" align="left">Dayend CBS Trans. No</th>
            <th valign="middle" width="3%" class="lbl-b-08" align="left">Dayend Ref NO</th>
            <th valign="middle" width="3%" class="lbl-b-08" align="left">Create By</th> 
                         
          </tr>
          <%
					if(session.getAttribute("oNescoDayEndTransactionSettlementReportBO")!=null){
			NescoDayEndTransactionSettlementReportBO mainBO=(NescoDayEndTransactionSettlementReportBO)session.getAttribute("oNescoDayEndTransactionSettlementReportBO");
			...
			NescoDayEndTransactionSettlementReportBO bo=(NescoDayEndTransactionSettlementReportBO)aDestinationBankList.get(i);
                    ...
                    String AgentRefNo = bo.getAgentRefNo(); 
                    String CbsRefNo = bo.getCbsRefNo(); 
                    String DayendRefNo = bo.getDayendRefNo(); 
                  ...
                  <td valign="top" class="lbl-08" align="center"><%= bo.getsSl()%></td> 
                    ...
                    <td align="center" valign="top" class="lbl-08"><%=AgentRefNo%></td>
                    <td align="center" valign="top" class="lbl-08"><%=CbsRefNo%></td>
                    <td align="center" valign="top" class="lbl-08"><%=DayendRefNo%></td>
