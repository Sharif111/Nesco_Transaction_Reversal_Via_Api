...
<%@ page import="com.adminpanel.merchantadminpanel.nesco.report.bo.NescoTransactionReverseReportBO"%>
...
<script language="javascript" type="text/javascript">
	...
	function doMainMenu(f){
		f.action="/merchantadminpanel/cancelNescoTransactionReverseReport.do";
		f.submit();
	}	
	function doLogOut(f){		
	    var f = document.nescoTransactionReverseReportForm;
		f.action="/merchantadminpanel/logOutIBanking.do";
		f.submit();
	}
	function doMenuList(f){
		f.action=document.nescoTransactionReverseReportForm.menu.value;
		f.submit();
	}	
	
	function doSearch(){		
		var f = document.nescoTransactionReverseReportForm;			
	 	f.action="/merchantadminpanel/showDataNescoTransactionReverseReport.do";
	 	f.submit();			
	}
    ...
    function doClear(f){	 
	 	f.action="/merchantadminpanel/reversalDetailsOfNescoTransactionReversalReport.do";
		f.submit();	 
	 } 
...
<body onLoad="setBodyProperty()">
  <html:form action="/nescoTransactionReverseReport" enctype="multipart/form-data" style="margin: 0">
                    ...
                    <td width="92%" class="myBankHeader"><table width="100%" border="0" cellspacing="3" cellpadding="0">
                        ...
                        <tr>
                          <td height="21" align="left" valign="top">&nbsp;</td>
                            ...
                            </font><font class="usr-4">Nesco Transaction Daily Reversal Report</font></td>
                          <td colspan="2" align="right" valign="top"><a href="#" onClick="doMainMenu(nescoTransactionReverseReportForm)"><font class="usr-5">
      ...
      <tr>
        <td valign="top">
            ...
            <tr class="spaceUnder">
              ...
              <input type="button" value="Clear" style="color:#03F;width:105px;margin-right:50px" name="sendMail" onClick="doClear(nescoTransactionReverseReportForm)" /></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
    ...
    <div class="modal fade" id="confirm-submit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm">
         ...
         <div class="modal-footer">
              ...
              <a href="#" onClick="doSearch(nescoTransactionReverseReportForm)" class="btn btn-success success">Search</a>
          </div>
      </div>
    </div>
  </div>
  ...
  <tr>
    <td colspan="9">
        ...
        <tr bgcolor="#99CCCC">
          ...
          <%
					if(session.getAttribute("oNescoTransactionReverseReportBO")!=null){
						NescoTransactionReverseReportBO mainBO=(NescoTransactionReverseReportBO)session.getAttribute("oNescoTransactionReverseReportBO");
					...
					for(int i=0;i<aDestinationBankList.size();i++){
						NescoTransactionReverseReportBO bo=(NescoTransactionReverseReportBO)aDestinationBankList.get(i);
